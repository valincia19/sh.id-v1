...
const options = {
    definition: {
        ...
        paths: {
            ...
            // ────────── KEY VALIDATION (OPENAPI MICROSERVICE) ──────────
            "/v2/keys/validate": {
                post: {
                    tags: ["Scripts"],
                    summary: "Validate a License Key for Executor Telemetry",
                    description: "Note: This endpoint must be hit at the `openapi` microservice port.",
                    requestBody: {
                        required: true,
                        content: {
                            "application/json": {
                                schema: {
                                    ...
                                    required: ["key", "hwid"],
                                    properties: {
                                        key: { type: "string", description: "The SH-id... license key" },
                                        hwid: { type: "string", description: "Hardware ID identifier" },
                                        executor: { type: "string", description: "Executor name (e.g. Synapse)" },
                                        robloxUsername: { type: "string", description: "Roblox player username" },
                                        robloxUserId: { type: "integer", description: "Roblox player ID" },
                                        scriptId: { type: "string", format: "uuid", description: "Optional Script ID restriction" }
                                    },
                                },
                            },
                        },
                    ...
                    responses: {
                        200: { description: "Key valid and logged" },
                        403: { description: "Key invalid, locked, or expired" },
