...
# Map app S3 credentials to AWS CLI expected env vars
...
RANDOM_SUFFIX=$(head -c 32 /dev/urandom | xxd -p | head -c 48)
BACKUP_FILE="/tmp/scripthub_${TIMESTAMP}_${RANDOM_SUFFIX}.dump"
BACKUP_GZ="/tmp/scripthub_${TIMESTAMP}_${RANDOM_SUFFIX}.dump.gz"
S3_KEY="${S3_PREFIX}/${DATE_FOLDER}/scripthub_${TIMESTAMP}_${RANDOM_SUFFIX}.dump.gz"
