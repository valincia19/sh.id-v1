...
export default function AdminOverviewPage() {
    ...
    useEffect(() => {
        ...
        const loadStats = async () => {
            try {
                ...
                setError("Backend /admin/stats not implemented yet.");
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const quickLinks = [
        ...
        { label: "CDN Storage", href: "/admin/cdn", desc: "Manage static assets", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-rose-400"><ellipse cx="12" cy="5" rx="9" ry="3" /><path d="M3 5v14a9 3 0 0 0 18 0V5" /><path d="M3 12a9 3 0 0 0 18 0" /></svg> },
        { label: "Stub Editor", href: "/admin/settings/stub", desc: "Edit core Lua stubs", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-rose-400"><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></svg> },
        { label: "Loaders", href: "/admin/settings/loaders", desc: "Manage layer-2 lua loaders", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-rose-400"><path d="M2 13h20" /><path d="M12 2v20" /><path d="m5 16 7-7 7 7" /></svg> },
    ];
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
            ...
            {error && (
                <div className="p-4 rounded-xl border border-rose-500/20 bg-rose-500/5 text-sm text-rose-400 font-mono flex items-center gap-2">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>
                    {error}
                </div>
            )}
