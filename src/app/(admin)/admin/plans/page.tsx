            ...
            <div className="relative z-10 w-full max-w-md bg-[#0c0e13] border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/50 animate-in fade-in zoom-in-95 duration-200"
                ...
                <div className="px-6 py-5 space-y-4">
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        <div>
                            <p className={labelClass}><span className="inline-flex items-center gap-1"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z" /><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z" /></svg>Deploys</span></p>
                            <input type="number" min="0" value={deployments} onChange={e => setDeployments(e.target.value)} className={inputClass} />
                        </div>
                        <div>
                            <p className={labelClass}><span className="inline-flex items-center gap-1"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4" /></svg>Keys</span></p>
                            <input type="number" min="0" value={keys} onChange={e => setKeys(e.target.value)} className={inputClass} />
                        </div>
                        <div>
                            <p className={labelClass}><span className="inline-flex items-center gap-1"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>Obfusc.</span></p>
                            <input type="number" min="0" value={obfuscation} onChange={e => setObfuscation(e.target.value)} className={inputClass} />
                        </div>
                        <div>
                            <p className={labelClass}><span className="inline-flex items-center gap-1"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="14" height="20" x="5" y="2" rx="2" ry="2" /><path d="M12 18h.01" /></svg>Dev/Key</span></p>
                                    ...
                                    <tr key={p.id} className="hover:bg-white/[0.01] transition-colors" onClick={() => setOpenMenuId(null)}>
                                        ...
                                        <td className="px-4 py-3">
                                            <div className="flex gap-2 text-[10px] font-mono">
                                                <span className="text-offgray-400 inline-flex items-center gap-0.5" title="Deployments"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z" /><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z" /></svg>{p.maximum_deployments ?? 0}</span>
                                                <span className="text-offgray-400 inline-flex items-center gap-0.5" title="Keys"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4" /></svg>{p.maximum_keys ?? 0}</span>
                                                <span className="text-offgray-400 inline-flex items-center gap-0.5" title="Obfuscation"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>{p.maximum_obfuscation ?? 0}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap">
                                            {p.expires_at ? (
                                                <span className={`text-[11px] font-mono ${isExpired(p.expires_at) ? "text-rose-400" : "text-offgray-500"}`}>
                                                    {isExpired(p.expires_at) && <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline mr-0.5"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>}{formatDate(p.expires_at)}
                                                </span>
                                            ) : (
