...
function ExecutorCardSkeleton() {
  return (
    <div className="flex flex-col w-full bg-white/[0.02] border border-white/[0.04] rounded-lg overflow-hidden animate-pulse h-full">
      {/* Thumbnail area */}
      <div className="relative w-full h-[100px] bg-white/[0.04]" />
      ...
      <div className="p-3 flex flex-col flex-1 gap-2">
        <div>
          <div className="flex justify-between items-start mb-1">
            ...
            <div className="h-4 w-12 bg-white/[0.04] rounded ml-2 shrink-0" />
          </div>
          <div className="h-2.5 w-1/3 bg-white/[0.04] rounded my-2" />
