    ...
    <div className="space-y-8">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {hubs.length === 0 && (
            <div className="text-center py-12 text-offgray-500 rounded-xl border border-white/[0.04] bg-surface-panel/50">
              <p className="text-sm">No hubs found yet.</p>
            </div>
          )}
        </>
      )}
...
function HubCardSkeleton() {
  return (
    <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] overflow-hidden animate-pulse">
      {/* Banner */}
      ...
      <div className="relative px-4 pb-4">
        ...
        <div className="-mt-8 mb-3">
          <div className="w-16 h-16 rounded-xl border-4 border-[#0a0c0f] bg-white/[0.06] overflow-hidden" />
        </div>
