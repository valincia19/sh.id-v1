            ...
            <div className="space-y-8 animate-in fade-in duration-700">
                <section className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                        <h1 className="text-2xl md:text-3xl font-serif tracking-tight text-white">Executors</h1>
                        <p className="text-sm font-mono text-offgray-500 max-w-lg mt-2">Manage your executor brands and releases</p>
                    </div>
                </section>
                    ...
                    >
                        ...
                        <div className="relative w-14 h-14 rounded-lg overflow-hidden bg-black/50 border border-white/[0.06] shrink-0 group-hover:border-white/[0.1] transition-colors mt-1 sm:mt-0 flex items-center justify-center">
                            {executor.logoUrl ? (
                                ...
                                <div className="text-lg font-serif font-semibold text-offgray-600 tracking-tighter">
