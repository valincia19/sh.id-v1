        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <section className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="space-y-1">
                    <h1 className="text-2xl md:text-3xl font-serif tracking-tight text-white">Obfuscations</h1>
                    <p className="text-sm font-mono text-offgray-500 max-w-lg mt-2">Secure and obfuscate your Lua payloads.</p>
                </div>
            </section>
