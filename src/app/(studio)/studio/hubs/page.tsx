            ...
            <div className="space-y-8 animate-in fade-in duration-700">
                <section className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                        <h1 className="text-2xl md:text-3xl font-serif tracking-tight text-white">Collectives</h1>
                        <p className="text-sm font-mono text-offgray-500 max-w-lg mt-2">Manage your brand hubs and grouped scripts</p>
                    </div>
                </section>

                <div className="flex flex-col items-center justify-center py-12 sm:py-20 px-4 min-h-[400px] border border-dashed border-white/[0.05] rounded-xl bg-white/[0.01] relative overflow-hidden group">
                    <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center opacity-[0.02]" style={{ backgroundSize: '20px 20px' }} />
                    <div className="shrink-0 w-16 h-16 rounded-2xl bg-[#11141A] border border-white/[0.06] shadow-2xl flex items-center justify-center mb-6 relative z-10 group-hover:border-[#10B981]/30 transition-colors duration-500">
                    ...
                    <Link
                        ...
                        className="relative z-10 inline-flex shrink-0 whitespace-nowrap items-center justify-center gap-2 h-9 px-4 rounded-md bg-[#059669] hover:bg-[#10B981] text-xs font-medium text-white transition-all shadow-lg shadow-[#10B981]/20 hover:shadow-[#10B981]/40 overflow-hidden"
                    >
                    ...
                    >
                        ...
                        <div className="relative w-14 h-14 rounded-lg overflow-hidden bg-black/50 border border-white/[0.06] shrink-0 group-hover:border-white/[0.1] transition-colors mt-1 sm:mt-0">
                            {hub.logoUrl ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-lg font-serif font-semibold text-offgray-600 bg-[url('/grid.svg')] bg-center tracking-tighter" style={{ backgroundSize: '10px 10px' }}>
                                    {hub.name.charAt(0)}
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-center space-y-1 mb-4 sm:mb-0">
                            ...
                            <p className="text-[13px] text-offgray-400 truncate max-w-xl">
