  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-white/[0.04] bg-[#0a0c10]/80 px-6 py-14 text-center flex flex-col items-center justify-center shadow-2xl">
        ...
        <div className="relative z-10 space-y-5 max-w-2xl mx-auto">
          ...
          <div className="pt-2 flex flex-wrap justify-center gap-3">
            <Link href="/studio/scripts/new" className="group relative inline-flex items-center gap-2 h-9 px-4 rounded-md bg-[#059669] hover:bg-[#10B981] text-xs font-medium text-white transition-all shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/25 overflow-hidden">
              <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity" />
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14" /></svg>
              New Script
            </Link>
            <Link href="/studio/deployments/upload" className="inline-flex items-center gap-2 h-9 px-4 rounded-md bg-white/[0.04] border border-white/[0.08] text-xs font-medium text-offgray-300 hover:bg-white/[0.08] hover:text-white transition-colors">
            ...
            <Link href="/studio/keys" className="inline-flex items-center gap-2 h-9 px-4 rounded-md bg-white/[0.04] border border-white/[0.08] text-xs font-medium text-offgray-300 hover:bg-white/[0.08] hover:text-white transition-colors">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex justify-between text-[10px] font-mono text-offgray-600">
                ...
                <span>{usedKeys} / {maxKeys} limit</span>
              </div>
            </div>
          </div>
        </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-1 relative p-5 bg-[#0a0c10] border border-white/[0.04] rounded-xl overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="space-y-0.5">
              ...
              {plan?.plan?.expires_at && (
                <p className={`text-[10px] font-mono ${new Date(plan.plan.expires_at) < new Date() ? 'text-rose-400' : 'text-offgray-500'}`}>
                  {new Date(plan.plan.expires_at) < new Date() ? 'Expired' : 'Expires'}: {formatDate(plan.plan.expires_at)}
                </p>
              )}
            </div>
            <span className="text-[10px] font-mono font-semibold uppercase tracking-widest px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
          ...
          <div className="mt-auto pt-5">
            <Link href="/studio/plans" className="block text-center py-2.5 rounded-lg border border-white/[0.06] bg-white/[0.02] text-[11px] font-mono text-offgray-500 hover:text-white hover:bg-white/[0.04] hover:border-emerald-500/20 hover:shadow-[0_0_15px_-5px_rgba(16,185,129,0.1)] transition-all duration-300">
              Manage Plan →
            </Link>
          </div>
        </div>
