                        ...
                        <div className="px-5 py-4 hover:bg-white/[0.015] transition-colors">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div className="space-y-1 md:max-w-xs xl:max-w-sm">
                                    <p className="text-[14px] font-medium text-offgray-100">Global API Key</p>
                                    <p className="text-[12px] font-mono leading-relaxed text-offgray-500">
                                ...
                                <div className="flex items-center gap-2 w-full md:w-auto">
                                    <div className="flex-1 md:w-[280px] h-9 px-3 bg-[#12151a] border border-white/[0.06] rounded-lg flex items-center overflow-hidden">
                                        {loading ? (
                                            <span className="text-[13px] font-mono text-offgray-600 italic">Loading configuration...</span>
                                        ) : apiKey ? (
                                            <code className="text-[14px] font-mono text-emerald-400 truncate select-all">{apiKey}</code>
                                        ) : (
                                            <span className="text-[13px] font-mono text-offgray-600 italic">No API key generated</span>
                                        )}
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="h-9 px-4 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 hover:bg-emerald-500/20 hover:text-emerald-300 transition-colors flex items-center gap-1.5 text-xs font-medium whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                        ...
                        <div className="px-5 py-4 hover:bg-white/[0.015] transition-colors">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div className="space-y-1 max-w-lg">
                                    <p className="text-[14px] font-medium text-blue-400">REST API Documentation</p>
                                ...
                                <Link
                                    href="/api-docs"
                                    className="h-9 px-4 inline-flex items-center justify-center gap-1.5 rounded-md bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 text-blue-400 text-xs font-medium tracking-wide transition-colors shrink-0"
                                >
                                    View Docs
            ...
            {showConfirm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#12151a] border border-white/[0.08] rounded-2xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="p-6">
                            <p className="text-[14px] text-offgray-300 leading-relaxed mb-4">
                            ...
                            <p className="text-[14px] text-offgray-400 mb-6">
                                Are you absolutely sure you want to proceed?
                            </p>
                            <div className="flex items-center gap-3 justify-end">
                                <button
                                    onClick={() => setShowConfirm(false)}
                                    className="px-4 py-2 rounded-xl text-[14px] font-medium text-offgray-400 hover:text-white hover:bg-white/[0.04] transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleGenerateKey}
                                    className="px-4 py-2 rounded-xl text-[14px] font-medium bg-red-500 text-white hover:bg-red-600 transition-colors shadow-[0_0_15px_rgba(239,68,68,0.2)]"
                                >
                                    Yes, Regenerate Key
                                </button>
                            </div>
